...
from modules.gui.set_up_3d import board, grid, windows, examples
...
class SudokuSolver3D:
    ...
    def face_click(self,event):
        board.choose_face_to_add(self,event)

    def button_click(self,event):
        board.choose_where_add(self,event)

    def line_click(self,event):
        board.add_new_face(self,event)
    ...
    def start_board_click(self):
        ...
        elif not board.check_3d_board_valid(self):
    ...
    def square_click(self,event):
        grid.input_number(self)

    def enter_number_click(self,event):
        grid.enter_number(self)
